#This is a common library file which includes all the required libraries and functions which are common to all initializations
#such as NMF for random initialization, NMF harmonic and NMF score informed.
